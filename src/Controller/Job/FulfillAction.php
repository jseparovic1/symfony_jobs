...
class FulfillAction extends BaseAction
{
    /**
     * @var JobRepository
     */
    ...
    public function __invoke(Request $request)
    {
        ...
        if (!$jobStateMachine->can(JobTransitions::TRANSITION_FULFILL)) {
            throw new BadRequestHttpException("Job can't be fulfilled.");
        }
        $jobStateMachine->apply(JobTransitions::TRANSITION_FULFILL);
